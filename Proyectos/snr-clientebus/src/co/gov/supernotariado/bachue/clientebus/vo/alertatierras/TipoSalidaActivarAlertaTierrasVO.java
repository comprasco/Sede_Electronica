 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoSalidaActivarAlertaTierrasVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.alertatierras
 * Nombre del elemento: TipoSalidaActivarAlertaTierrasVO
 ...
 * Tipo salida activar alerta tierras .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoSalidaActivarAlertaTierrasVO extends ClienteIntegracionVO {
