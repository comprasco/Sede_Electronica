 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoSolicitanteCESIVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.generacionsolicitud
 * Nombre del elemento: TipoSolicitanteCESIVO
 ...
 * Tipo solicitante CESI .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoSolicitanteCESIVO extends GenericoVO {
