 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoSalidaActualizarDatosSolicitanteVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.operacionesfinancieras
 * Nombre del elemento: TipoSalidaActualizarDatosSolicitanteVO
 ...
 * Tipo salida actualizar datos solicitante .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoSalidaActualizarDatosSolicitanteVO extends ClienteIntegracionVO{
