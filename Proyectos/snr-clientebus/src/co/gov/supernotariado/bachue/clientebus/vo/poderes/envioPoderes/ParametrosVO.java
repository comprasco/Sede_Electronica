...
public class ParametrosVO extends ClienteIntegracionVO{

	private static final long serialVersionUID = 1L;

	private String is_dDocType;
	private String is_dDocTittle;
	private String is_xComments;
	private String is_xIdcProfile;
	...
	public String getIs_dDocTittle() {
		return is_dDocTittle;
	}
	public void setIs_dDocTittle(String as_dDocTittle) {
		this.is_dDocTittle = as_dDocTittle;
	}
	...
	public String getIs_xIdcProfile() {
		return is_xIdcProfile;
	}
	public void setIs_xIdcProfile(String as_xIdcProfile) {
		this.is_xIdcProfile = as_xIdcProfile;
	}
	...
	public Date getId_dOutDate() {
		return id_dOutDate;
	}
	public void setId_dOutDate(Date ad_dOutDate) {
		this.id_dOutDate = ad_dOutDate;
	}
	...
	public String getIs_xActualizarDocumento() {
		return is_xActualizarDocumento;
	}
	public void setIs_xActualizarDocumento(String as_xActualizarDocumento) {
		this.is_xActualizarDocumento = as_xActualizarDocumento;
	}
	...
	public String getIs_xNotificaciones() {
		return is_xNotificaciones;
	}
	public void setIs_xNotificaciones(String as_xNotificaciones) {
		this.is_xNotificaciones = as_xNotificaciones;
	}
