 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoSalidaRechazarCorreccionAlertaVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.alertatierras
 * Nombre del elemento: TipoSalidaRechazarCorreccionAlertaVO
 ...
 * Tipo salida rechazar correccion alerta .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoSalidaRechazarCorreccionAlertaVO extends ClienteIntegracionVO {
