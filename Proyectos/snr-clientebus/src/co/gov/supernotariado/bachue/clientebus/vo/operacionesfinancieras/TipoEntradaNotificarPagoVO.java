 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoEntradaNotificarPagoVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.operacionesfinancieras
 * Nombre del elemento: TipoEntradaNotificarPagoVO
 ...
 * Tipo entrada notificar pago .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoEntradaNotificarPagoVO extends ClienteIntegracionVO {
