 ...
 * ----------------------------------------------
 * Nombre del archivo: SalidaCancelacionTransaccionVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.pasarela
 * Nombre del elemento: SalidaCancelacionTransaccionVO
 ...
 * Salida cancelacion transaccion .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class SalidaCancelacionTransaccionVO extends ClienteIntegracionVO implements Serializable{
	 ...
	 * SalidaCancelacionTransaccionVO.
	 */
	public SalidaCancelacionTransaccionVO() {
