...
/**
 * <p>Clase Java para tipoUsuarioIUI complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="tipoUsuarioIUI">
 *   &lt;complexContent>
...
@XmlType(name = "tipoUsuarioIUI", propOrder = {
    "tipoDocUsuario",
    "numDocUsuario",
    "primerNombreUsuario",
...
public class TipoUsuarioIUI {
    ...
    @XmlElementRef(name = "segundoNombreUsuario", namespace = "https://www.supernotariado.gov.co/schemas/bachue/cb/gestioncuentacupos/inscribirusuario/v1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> segundoNombreUsuario;
    @XmlElement(required = true)
    protected String primerApellidoUsuario;
    @XmlElementRef(name = "segundoApellidoUsuario", namespace = "https://www.supernotariado.gov.co/schemas/bachue/cb/gestioncuentacupos/inscribirusuario/v1", type = JAXBElement.class, required = false)
