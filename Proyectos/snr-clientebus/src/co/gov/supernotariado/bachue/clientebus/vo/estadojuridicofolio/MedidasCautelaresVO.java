 ...
 * ----------------------------------------------
 * Nombre del archivo: MedidasCautelaresVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.estadojuridicofolio
 * Nombre del elemento: MedidasCautelaresVO
 ...
 * @version 1.0
 */
public class MedidasCautelaresVO extends GenericoVO
{
    ...
    /**
	 * Atributo de instancia tipo lista de IntervinientesVO para definir la
	 * propiedad lista intervinientes.
	 */
    private List<IntervinientesVO> ili_listaIntervinientes;
    
    /**
	 * Atributo de instancia tipo lista de AnotacionesCanceladasVO para definir la
	 * propiedad lista anotaciones canceladas.
	 */
    private List<AnotacionesCanceladasVO> ilac_listaAnotacionesCanceladas;
	 ...
	 */
	public List<IntervinientesVO> getIli_listaIntervinientes() {
	 ...
	 *                                intervinientes
	 */
	public void setIli_listaIntervinientes(List<IntervinientesVO> ali_listaIntervinientes) {
	 ...
	 */
	public List<AnotacionesCanceladasVO> getIlac_listaAnotacionesCanceladas() {
	 ...
	 */
	public void setIlac_listaAnotacionesCanceladas(List<AnotacionesCanceladasVO> alac_listaAnotacionesCanceladas) {
