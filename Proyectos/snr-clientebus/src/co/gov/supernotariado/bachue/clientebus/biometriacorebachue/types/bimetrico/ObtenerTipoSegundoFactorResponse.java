...
/**
 * <p>Clase Java para obtenerTipoSegundoFactorResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="obtenerTipoSegundoFactorResponse">
 *   &lt;complexContent>
...
@XmlType(name = "obtenerTipoSegundoFactorResponse", propOrder = {
    "salidaResultado"
})
public class ObtenerTipoSegundoFactorResponse {
