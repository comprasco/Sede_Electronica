 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoSalidaIngresoSolicitudVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.solicitudcopias
 * Nombre del elemento: TipoSalidaIngresoSolicitudVO
 ...
 * Tipo salida ingreso solicitud .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoSalidaIngresoSolicitudVO extends ClienteIntegracionVO {
