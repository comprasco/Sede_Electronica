 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoEntradaInactivarAlertaVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.alertatierras
 * Nombre del elemento: TipoEntradaInactivarAlertaVO
 ...
 * Tipo entrada inactivar alerta .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoEntradaInactivarAlertaVO extends ClienteIntegracionVO {
