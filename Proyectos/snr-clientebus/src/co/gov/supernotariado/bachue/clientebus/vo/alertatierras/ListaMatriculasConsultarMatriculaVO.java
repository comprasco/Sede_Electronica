 ...
 * ----------------------------------------------
 * Nombre del archivo: ListaMatriculasConsultarMatriculaVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.alertatierras
 * Nombre del elemento: ListaMatriculasConsultarMatriculaVO
 ...
 * Lista matriculas consultar matricula .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class ListaMatriculasConsultarMatriculaVO extends GenericoVO {
