...
/**
 * <p>Clase Java para tipoSalidaObtenerUsuariosRolOrip complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="tipoSalidaObtenerUsuariosRolOrip">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="usuarios" type="{https://www.supernotariado.gov.co/schemas/bachue/cb/gestionusuarios/obtenerusuariosrolorip/v1}tipoUsuario" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "tipoSalidaObtenerUsuariosRolOrip", propOrder = {
    "usuarios",
    "codigoMensaje",
    "descripcionMensaje"
})
public class TipoSalidaObtenerUsuariosRolOrip {

    @XmlElement(nillable = true)
    protected List<TipoUsuario> usuarios;
    ...
    public List<TipoUsuario> getUsuarios() {
        if (usuarios == null) {
            usuarios = new ArrayList<TipoUsuario>();
        }
