 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoSalidaCancelarUsuarioVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.gestioncuentacupos
 * Nombre del elemento: TipoSalidaCancelarUsuarioVO
 ...
 * Tipo salida cancelar usuario .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoSalidaCancelarUsuarioVO extends ClienteIntegracionVO{
