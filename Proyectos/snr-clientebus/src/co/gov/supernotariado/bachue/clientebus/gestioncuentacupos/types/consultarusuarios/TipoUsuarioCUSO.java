...
/**
 * <p>Clase Java para tipoUsuarioCUSO complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="tipoUsuarioCUSO">
 *   &lt;complexContent>
...
@XmlType(name = "tipoUsuarioCUSO", propOrder = {
    "tipoDocUsuario",
    "numDocUsuario",
    "primerNombreUsuario",
...
public class TipoUsuarioCUSO {
    ...
    @XmlElementRef(name = "segundoNombreUsuario", namespace = "https://www.supernotariado.gov.co/schemas/bachue/cb/gestioncuentacupos/consultarusuarios/v1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> segundoNombreUsuario;
    @XmlElement(required = true)
    protected String primerApellidoUsuario;
    @XmlElementRef(name = "segundoApellidoUsuario", namespace = "https://www.supernotariado.gov.co/schemas/bachue/cb/gestioncuentacupos/consultarusuarios/v1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> segundoApellidoUsuario;
    @XmlElement(required = true)
    protected String correoElectronicoCorporativoUsuario;
    @XmlElement(required = true)
    protected String estado;
    @XmlElementRef(name = "fechaCreacion", namespace = "https://www.supernotariado.gov.co/schemas/bachue/cb/gestioncuentacupos/consultarusuarios/v1", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> fechaCreacion;
    @XmlElementRef(name = "fechaCancelacion", namespace = "https://www.supernotariado.gov.co/schemas/bachue/cb/gestioncuentacupos/consultarusuarios/v1", type = JAXBElement.class, required = false)
