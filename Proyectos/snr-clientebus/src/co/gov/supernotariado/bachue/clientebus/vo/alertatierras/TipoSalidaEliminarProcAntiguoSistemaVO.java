 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoSalidaEliminarProcAntiguoSistemaVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.alertatierras
 * Nombre del elemento: TipoSalidaEliminarProcAntiguoSistemaVO
 ...
 * Tipo salida eliminar proc antiguo sistema .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoSalidaEliminarProcAntiguoSistemaVO extends ClienteIntegracionVO {
