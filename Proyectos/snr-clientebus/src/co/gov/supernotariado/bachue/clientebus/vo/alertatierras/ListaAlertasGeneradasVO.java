 ...
 * ----------------------------------------------
 * Nombre del archivo: ListaAlertasGeneradasVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.alertatierras
 * Nombre del elemento: ListaAlertasGeneradasVO
 ...
 * Lista alertas generadas .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class ListaAlertasGeneradasVO extends GenericoVO {
