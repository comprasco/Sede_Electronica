 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoSalidaInactivarAlertaVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.alertatierras
 * Nombre del elemento: TipoSalidaInactivarAlertaVO
 ...
 * Tipo salida inactivar alerta .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoSalidaInactivarAlertaVO extends ClienteIntegracionVO {
