 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoEntradaValidarSolicitudAlertaMasivaVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.gestionalertastitulares
 * Nombre del elemento: TipoEntradaValidarSolicitudAlertaMasivaVO
 ...
 * Tipo entrada validar solicitud alerta masiva .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoEntradaValidarSolicitudAlertaMasivaVO extends ClienteIntegracionVO{
