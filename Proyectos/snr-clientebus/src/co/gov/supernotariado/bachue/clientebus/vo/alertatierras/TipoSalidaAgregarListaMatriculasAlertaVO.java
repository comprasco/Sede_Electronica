 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoSalidaAgregarListaMatriculasAlertaVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.alertatierras
 * Nombre del elemento: TipoSalidaAgregarListaMatriculasAlertaVO
 ...
 * Tipo salida agregar lista matriculas alerta .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoSalidaAgregarListaMatriculasAlertaVO extends ClienteIntegracionVO {
