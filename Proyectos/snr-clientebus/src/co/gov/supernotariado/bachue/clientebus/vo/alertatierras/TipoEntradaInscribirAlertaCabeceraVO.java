 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoEntradaInscribirAlertaCabeceraVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.alertatierras
 * Nombre del elemento: TipoEntradaInscribirAlertaCabeceraVO
 ...
 * Tipo entrada inscribir alerta cabecera .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoEntradaInscribirAlertaCabeceraVO extends ClienteIntegracionVO {
