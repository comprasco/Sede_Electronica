 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoSalidaCancelarIngresoAlertaTierrasVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.alertatierras
 * Nombre del elemento: TipoSalidaCancelarIngresoAlertaTierrasVO
 ...
 * Tipo salida cancelar ingreso alerta tierras .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoSalidaCancelarIngresoAlertaTierrasVO extends ClienteIntegracionVO {
