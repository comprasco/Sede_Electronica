...
/**
 * <p>Clase Java para tipoSalidaObtenerAccesosPorRol complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="tipoSalidaObtenerAccesosPorRol">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="accesos" type="{https://www.supernotariado.gov.co/schemas/bachue/cb/gestionusuarios/obteneraccesosporrol/v1}tipoAcceso" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "tipoSalidaObtenerAccesosPorRol", propOrder = {
    "accesos",
    "codigoMensaje",
    "descripcionMensaje"
})
public class TipoSalidaObtenerAccesosPorRol {

    @XmlElement(nillable = true)
    protected List<TipoAcceso> accesos;
     ...
     * 
     */
    public List<TipoAcceso> getAccesos() {
        if (accesos == null) {
            accesos = new ArrayList<TipoAcceso>();
        }
        return this.accesos;
    }
