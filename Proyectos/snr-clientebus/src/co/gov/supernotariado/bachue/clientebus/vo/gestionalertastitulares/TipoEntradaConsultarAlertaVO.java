 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoEntradaConsultarAlertaVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.gestionalertastitulares
 * Nombre del elemento: TipoEntradaConsultarAlertaVO
 ...
 * Tipo entrada consultar alerta .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoEntradaConsultarAlertaVO extends ClienteIntegracionVO
{
