 ...
 * @version 1.0
 */
public class TipoServicioCTSIVO extends ClienteIntegracionVO {
    ...
    /**
	 * Atributo de instancia tipo lista de TipoCriterioCTSIVO para definir la
	 * propiedad criterios.
	 */
    private  List<TipoCriterioCTSIVO> iltc_criterios;
	 ...
	 */
	public List<TipoCriterioCTSIVO> getIltc_criterios() {
	 ...
	 */
	public void setIltc_criterios(List<TipoCriterioCTSIVO> altc_criterios) {
