 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoEntradaConsultarDatosRegistralesVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.consultardatosregistrales
 * Nombre del elemento: TipoEntradaConsultarDatosRegistralesVO
 ...
 * Tipo entrada consultar datos registrales .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoEntradaConsultarDatosRegistralesVO extends ClienteIntegracionVO {
