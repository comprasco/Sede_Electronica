 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoEntradaValidarSolicitudAlertaIndividualVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.gestionalertastitulares
 * Nombre del elemento: TipoEntradaValidarSolicitudAlertaIndividualVO
 ...
 * Tipo entrada validar solicitud alerta individual .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoEntradaValidarSolicitudAlertaIndividualVO extends ClienteIntegracionVO{
