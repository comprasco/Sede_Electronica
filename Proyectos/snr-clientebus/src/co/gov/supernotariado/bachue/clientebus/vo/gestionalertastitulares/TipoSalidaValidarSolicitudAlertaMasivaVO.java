 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoSalidaValidarSolicitudAlertaMasivaVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.gestionalertastitulares
 * Nombre del elemento: TipoSalidaValidarSolicitudAlertaMasivaVO
 ...
 * Tipo salida validar solicitud alerta masiva .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoSalidaValidarSolicitudAlertaMasivaVO extends ClienteIntegracionVO{
