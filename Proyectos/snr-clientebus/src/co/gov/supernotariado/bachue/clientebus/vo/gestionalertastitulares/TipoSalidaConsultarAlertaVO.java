 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoSalidaConsultarAlertaVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.gestionalertastitulares
 * Nombre del elemento: TipoSalidaConsultarAlertaVO
 ...
 * Tipo salida consultar alerta .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoSalidaConsultarAlertaVO extends ClienteIntegracionVO
{
	...
	/**
	 * Atributo de instancia tipo lista de AlertaVO para definir la propiedad lista
	 * alerta.
	 */
	private List<AlertaVO> ila_listaAlerta;
	 ...
	 */
	public List<AlertaVO> getIla_listaAlerta() 
	{
	 ...
	 */
	public void setIla_listaAlerta(List<AlertaVO> ala_listaAlerta) 
	{
