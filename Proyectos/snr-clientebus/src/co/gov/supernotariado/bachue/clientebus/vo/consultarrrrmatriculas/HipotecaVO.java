 ...
 * @version 1.0
 */
public class HipotecaVO extends GenericoVO{
	 ...
	 */
	public void setId_fechaAnotacion(Date as_fechaAnotacion) {
		this.id_fechaAnotacion = as_fechaAnotacion;
	}
