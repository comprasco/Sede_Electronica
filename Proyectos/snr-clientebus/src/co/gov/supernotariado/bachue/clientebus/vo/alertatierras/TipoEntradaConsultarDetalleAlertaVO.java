 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoEntradaConsultarDetalleAlertaVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.alertatierras
 * Nombre del elemento: TipoEntradaConsultarDetalleAlertaVO
 ...
 * Tipo entrada consultar detalle alerta .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoEntradaConsultarDetalleAlertaVO extends ClienteIntegracionVO {
