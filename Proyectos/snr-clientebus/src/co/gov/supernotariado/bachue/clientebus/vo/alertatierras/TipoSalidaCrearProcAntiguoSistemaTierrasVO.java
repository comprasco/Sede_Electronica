 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoSalidaCrearProcAntiguoSistemaTierrasVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.alertatierras
 * Nombre del elemento: TipoSalidaCrearProcAntiguoSistemaTierrasVO
 ...
 * Tipo salida crear proc antiguo sistema tierras .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoSalidaCrearProcAntiguoSistemaTierrasVO extends ClienteIntegracionVO {
