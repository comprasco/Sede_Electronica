 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoSalidaRemoverMatriculaAlertaVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.alertatierras
 * Nombre del elemento: TipoSalidaRemoverMatriculaAlertaVO
 ...
 * Tipo salida remover matricula alerta .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoSalidaRemoverMatriculaAlertaVO extends ClienteIntegracionVO {
