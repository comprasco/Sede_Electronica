 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoSalidaPagarCuentaCupoVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.gestioncuentacupos
 * Nombre del elemento: TipoSalidaPagarCuentaCupoVO
 ...
 * Tipo salida pagar cuenta cupo .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoSalidaPagarCuentaCupoVO extends ClienteIntegracionVO{
