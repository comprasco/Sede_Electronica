 ...
 */
@XmlRegistry
public class ConsultaTrazabilidadObjectFactory {

    private static final QName CQN_SALIDA_CONSULTAR_TRAZABILIDAD = new QName("https://www.supernotariado.gov.co/schemas/bachue/ee/consultatrazabilidad/consultartrazabilidad/v1", "salidaConsultarTrazabilidad");
    private static final QName CQN_ENTRADA_CONSULTAR_TRAZABILIDAD = new QName("https://www.supernotariado.gov.co/schemas/bachue/ee/consultatrazabilidad/consultartrazabilidad/v1", "entradaConsultarTrazabilidad");
     ...
     * 
     */
    public ConsultaTrazabilidadObjectFactory() {
    	//Constructor vacio
    }
    ...
    public JAXBElement<TipoSalidaConsultarTrazabilidad> createSalidaConsultarTrazabilidad(TipoSalidaConsultarTrazabilidad value) {
        return new JAXBElement<>(CQN_SALIDA_CONSULTAR_TRAZABILIDAD, TipoSalidaConsultarTrazabilidad.class, null, value);
    }
    ...
    public JAXBElement<TipoEntradaConsultarTrazabilidad> createEntradaConsultarTrazabilidad(TipoEntradaConsultarTrazabilidad value) {
        return new JAXBElement<>(CQN_ENTRADA_CONSULTAR_TRAZABILIDAD, TipoEntradaConsultarTrazabilidad.class, null, value);
    }
