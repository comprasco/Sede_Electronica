 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoRepresentanteLegalAEIVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.gestioncuentacupos
 * Nombre del elemento: TipoRepresentanteLegalAEIVO
 ...
 * Tipo representante legal AEI .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoRepresentanteLegalAEIVO extends GenericoVO{
