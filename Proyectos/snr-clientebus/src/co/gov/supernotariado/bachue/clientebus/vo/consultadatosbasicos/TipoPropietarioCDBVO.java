 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoPropietarioCDBVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.consultadatosbasicos
 * Nombre del elemento: TipoPropietarioCDBVO
 ...
 * Tipo propietario CDB .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoPropietarioCDBVO extends GenericoVO{
