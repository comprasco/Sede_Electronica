 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoEntradaListarProcAntiguoSistemaVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.alertatierras
 * Nombre del elemento: TipoEntradaListarProcAntiguoSistemaVO
 ...
 * Tipo entrada listar proc antiguo sistema .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoEntradaListarProcAntiguoSistemaVO extends ClienteIntegracionVO {
