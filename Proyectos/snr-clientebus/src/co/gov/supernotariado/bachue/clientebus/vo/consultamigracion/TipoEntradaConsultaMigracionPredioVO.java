 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoEntradaConsultaMigracionPredioVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.consultamigracion
 * Nombre del elemento: TipoEntradaConsultaMigracionPredioVO
 ...
 * Tipo entrada consulta migracion predio .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoEntradaConsultaMigracionPredioVO  extends ClienteIntegracionVO {
