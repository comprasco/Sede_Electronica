 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoEntradaConsultarPazySalvoTributarioVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.consultapazysalvotributario
 * Nombre del elemento: TipoEntradaConsultarPazySalvoTributarioVO
 ...
 * Tipo entrada consultar pazy salvo tributario .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoEntradaConsultarPazySalvoTributarioVO extends ClienteIntegracionVO
{
