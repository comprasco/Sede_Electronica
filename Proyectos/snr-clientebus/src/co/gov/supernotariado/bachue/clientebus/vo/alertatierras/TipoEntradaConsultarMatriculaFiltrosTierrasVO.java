 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoEntradaConsultarMatriculaFiltrosTierrasVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.alertatierras
 * Nombre del elemento: TipoEntradaConsultarMatriculaFiltrosTierrasVO
 ...
 * Tipo entrada consultar matricula filtros tierras .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoEntradaConsultarMatriculaFiltrosTierrasVO extends ClienteIntegracionVO {
