 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoSalidaEnviarDocumentoVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.enviardocumentos
 * Nombre del elemento: TipoSalidaEnviarDocumentoVO
 ...
 * Tipo salida enviar documento .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoSalidaEnviarDocumentoVO extends ClienteIntegracionVO{
