 ...
 * ----------------------------------------------
 * Nombre del archivo: ListaMatriculasConsultarMatriculaFiltrosTierrasVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.alertatierras
 * Nombre del elemento: ListaMatriculasConsultarMatriculaFiltrosTierrasVO
 ...
 * Lista matriculas consultar matricula filtros tierras .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class ListaMatriculasConsultarMatriculaFiltrosTierrasVO extends GenericoVO {
