 ...
 */
@XmlRegistry
public class ObjectFactoryConsultaPoderExt {
    ...
    /**
     * Create a new ConsultaActosTurnoObjectFactory that can be used to create new instances of schema derived classes for package: https.www_supernotariado_gov_co.schemas.bachue.co.consultapoderes.consultarpoder.v1
     * 
     */
    public ObjectFactoryConsultaPoderExt() {
    }
