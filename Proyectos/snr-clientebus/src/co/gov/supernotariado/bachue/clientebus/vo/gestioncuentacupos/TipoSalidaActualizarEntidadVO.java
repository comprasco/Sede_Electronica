 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoSalidaActualizarEntidadVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.gestioncuentacupos
 * Nombre del elemento: TipoSalidaActualizarEntidadVO
 ...
 * Tipo salida actualizar entidad .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoSalidaActualizarEntidadVO extends ClienteIntegracionVO{
