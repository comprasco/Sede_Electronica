 ...
 * generated in the https.www_supernotariado_gov_co.schemas.bachue.ee.alertatierras.inactivaralerta.v1 package. 
...
public class InactivarAlertaObjectFactory {
    ...
    private static final QName CQN_ENTRADA_INACTIVAR_ALERTA = new QName("https://www.supernotariado.gov.co/schemas/bachue/ee/alertaTierras/inactivarAlerta/v1", "entradaInactivarAlerta");
    private static final QName CQN_SALIDA_INACTIVAR_ALERTA = new QName("https://www.supernotariado.gov.co/schemas/bachue/ee/alertaTierras/inactivarAlerta/v1", "salidaInactivarAlerta");

    /**
     * Create a new ConsultaActosTurnoObjectFactory that can be used to create new instances of schema derived classes for package: https.www_supernotariado_gov_co.schemas.bachue.ee.alertatierras.inactivaralerta.v1
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://www.supernotariado.gov.co/schemas/bachue/ee/alertaTierras/inactivarAlerta/v1", name = "entradaInactivarAlerta")
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://www.supernotariado.gov.co/schemas/bachue/ee/alertaTierras/inactivarAlerta/v1", name = "salidaInactivarAlerta")
