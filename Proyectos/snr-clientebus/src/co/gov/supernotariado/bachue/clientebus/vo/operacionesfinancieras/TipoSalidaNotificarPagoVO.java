 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoSalidaNotificarPagoVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.operacionesfinancieras
 * Nombre del elemento: TipoSalidaNotificarPagoVO
 ...
 * Tipo salida notificar pago .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoSalidaNotificarPagoVO extends ClienteIntegracionVO {
