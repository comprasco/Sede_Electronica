 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoSalidaObtenerReciboCajaVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.entregaproducto
 * Nombre del elemento: TipoSalidaObtenerReciboCajaVO
 ...
 * Tipo salida obtener recibo caja .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoSalidaObtenerReciboCajaVO extends ClienteIntegracionVO 
{
