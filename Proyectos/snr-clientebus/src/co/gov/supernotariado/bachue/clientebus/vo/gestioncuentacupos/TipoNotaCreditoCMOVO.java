 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoNotaCreditoCMOVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.gestioncuentacupos
 * Nombre del elemento: TipoNotaCreditoCMOVO
 ...
 * Tipo nota credito CMO .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoNotaCreditoCMOVO extends GenericoVO{
