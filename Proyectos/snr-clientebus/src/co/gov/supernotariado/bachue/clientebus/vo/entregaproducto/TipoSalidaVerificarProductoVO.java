 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoSalidaVerificarProductoVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.entregaproducto
 * Nombre del elemento: TipoSalidaVerificarProductoVO
 ...
 * Tipo salida verificar producto .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoSalidaVerificarProductoVO extends ClienteIntegracionVO{
