 ...
 * Generar transaccion extendida .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class GenerarTransaccionExtendidaVO extends ClienteIntegracionVO implements IBancarizacionEntradaBase {
	...
	/**
	 * Atributo de instancia tipo lista de EntidadMatriculaVO para definir la
	 * propiedad matriculas.
	 */
	private List<EntidadMatriculaVO> ilem_matriculas;

	/*
	 * (non-Javadoc)
	 * 
	 * @see co.gov.supernotariado.bachue.clientebus.vo.bancarizacion.generico.
	 * IBancarizacionEntradaBase#getIs_usuarioWS()
	 */
	 ...
	 * 
	 * @see co.gov.supernotariado.bachue.clientebus.vo.bancarizacion.generico.
	 * IBancarizacionEntradaBase#setIs_usuarioWS(java.lang.String)
	 */
	 ...
	 * 
	 * @see co.gov.supernotariado.bachue.clientebus.vo.bancarizacion.generico.
	 * IBancarizacionEntradaBase#getIs_claveWS()
	 */
	 ...
	 * 
	 * @see co.gov.supernotariado.bachue.clientebus.vo.bancarizacion.generico.
	 * IBancarizacionEntradaBase#setIs_claveWS(java.lang.String)
	 */
	 ...
	 * 
	 * @see co.gov.supernotariado.bachue.clientebus.vo.bancarizacion.generico.
	 * IBancarizacionEntradaBase#getIs_codigoConvenio()
	 */
	 ...
	 * 
	 * @see co.gov.supernotariado.bachue.clientebus.vo.bancarizacion.generico.
	 * IBancarizacionEntradaBase#setIs_codigoConvenio(java.lang.String)
	 */
	 ...
	 * 
	 * @see co.gov.supernotariado.bachue.clientebus.vo.bancarizacion.generico.
	 * IBancarizacionEntradaBase#getIs_codigoServicio()
	 */
	 ...
	 * 
	 * @see co.gov.supernotariado.bachue.clientebus.vo.bancarizacion.generico.
	 * IBancarizacionEntradaBase#setIs_codigoServicio(java.lang.String)
	 */
	 ...
	 */
	public List<EntidadMatriculaVO> getIlem_matriculas() {
	 ...
	 *
	 * @param alem_matriculas el nuevo valor para la propiedad matriculas
	 */
	public void setIlem_matriculas(List<EntidadMatriculaVO> alem_matriculas) {
