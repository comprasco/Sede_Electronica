 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoEntradaAgregarMatriculaAlertaVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.alertatierras
 * Nombre del elemento: TipoEntradaAgregarMatriculaAlertaVO
 ...
 * Tipo entrada agregar matricula alerta .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoEntradaAgregarMatriculaAlertaVO extends ClienteIntegracionVO {
