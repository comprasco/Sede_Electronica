 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoSalidaConsultaEstadoLiquidacionVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.operacionesfinancieras
 * Nombre del elemento: TipoSalidaConsultaEstadoLiquidacionVO
 ...
 * Tipo salida consulta estado liquidacion .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoSalidaConsultaEstadoLiquidacionVO extends ClienteIntegracionVO{
