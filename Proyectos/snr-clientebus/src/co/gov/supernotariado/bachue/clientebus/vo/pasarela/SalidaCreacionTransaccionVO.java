 ...
 * ----------------------------------------------
 * Nombre del archivo: SalidaCreacionTransaccionVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.pasarela
 * Nombre del elemento: SalidaCreacionTransaccionVO
 ...
 * Salida creacion transaccion .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class SalidaCreacionTransaccionVO extends ClienteIntegracionVO implements Serializable{
	...
	/**
	 * Atributo de instancia tipo SalidaLogVO para definir la propiedad salida log.
	 */
	@SerializedName("log") 
	private SalidaLogVO isl_salidaLog;
	...
	/**
	 * Construye una nueva instancia/objeto de la clase SalidaCreacionTransaccionVO.
	 */
	public SalidaCreacionTransaccionVO() {
	...
	/**
	 * Obtiene el valor para la propiedad salida log.
	 *
	 * @return El valor de la propiedad salida log
	 */
	public SalidaLogVO getIsl_salidaLog() {
		return isl_salidaLog;
	}

	/**
	 * Cambia/actualiza el valor para la propiedad salida log.
	 *
	 * @param asl_salidaLog el nuevo valor para la propiedad salida log
	 */
	public void setIsl_salidaLog(SalidaLogVO asl_salidaLog) {
		this.isl_salidaLog = asl_salidaLog;
	}
