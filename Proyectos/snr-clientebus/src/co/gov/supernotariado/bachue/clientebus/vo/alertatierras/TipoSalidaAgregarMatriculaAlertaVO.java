 ...
 * ----------------------------------------------
 * Nombre del archivo: TipoSalidaAgregarMatriculaAlertaVO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.clientebus.vo.alertatierras
 * Nombre del elemento: TipoSalidaAgregarMatriculaAlertaVO
 ...
 * Tipo salida agregar matricula alerta .
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoSalidaAgregarMatriculaAlertaVO extends ClienteIntegracionVO {
