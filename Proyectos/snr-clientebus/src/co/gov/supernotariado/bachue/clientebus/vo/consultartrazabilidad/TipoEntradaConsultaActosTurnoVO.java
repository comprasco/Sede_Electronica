 ...
 * @version 1.0
 */
public class TipoEntradaConsultaActosTurnoVO extends ClienteIntegracionVO {
	...
	public void setIs_modulo(String is_modulo) {
		this.is_modulo = is_modulo;
	}
	public String getIs_criterioBusqueda() {
		return is_criterioBusqueda;
	}
	public void setIs_criterioBusqueda(String is_criterioBusqueda) {
		this.is_criterioBusqueda = is_criterioBusqueda;
	}
	public String getIs_valorCriterioBusqueda() {
		return is_valorCriterioBusqueda;
	}
	public void setIs_valorCriterioBusqueda(String is_valorCriterioBusqueda) {
		this.is_valorCriterioBusqueda = is_valorCriterioBusqueda;
	}
