 ...
 * --------------------------------------
 * Nombre del archivo: TipoNotaCreditoCMOWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoNotaCreditoCMOWSDTO
 ...
 * @version 1.0
 */
public class TipoNotaCreditoCMOWSDTO implements Serializable{
