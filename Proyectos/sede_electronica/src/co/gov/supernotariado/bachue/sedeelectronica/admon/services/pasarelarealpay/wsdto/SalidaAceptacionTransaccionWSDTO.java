 ...
 * --------------------------------------
 * Nombre del archivo: SalidaAceptacionTransaccionWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.pasarelarealpay.wsdto
 * Nombre del elemento: SalidaAceptacionTransaccionWSDTO
 ...
 * <br>
 * Contiene propiedades para representar los datos del objeto Salida aceptacion
 * transaccion. <br>
 ...
 * @version 1.0
 */
public class SalidaAceptacionTransaccionWSDTO extends GenericoDTO{
	 ...
	 */
	public SalidaAceptacionTransaccionWSDTO() {
