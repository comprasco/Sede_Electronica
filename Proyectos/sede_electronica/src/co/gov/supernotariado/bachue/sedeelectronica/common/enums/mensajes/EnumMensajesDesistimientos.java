 ...
 * --------------------------------------
 * Nombre del archivo: EnumMensajesDesistimientos.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.common.enums.mensajes
 * Nombre del elemento: EnumMensajesdesistimientos
...
/**
 * Enumeracion para definir el grupo de constantes para Mensajes desistimientos.
 * <br>
 ...
 * @version 1.0
 */
public enum EnumMensajesDesistimientos implements IEnumCatalogoMensajes {
	 ...
	 */
	TRANSACCION_DESCARTADA("eliminar.transaccion.desistimiento"),
	
	/**
	 * Constante de la enumeracion para definir el item: SOPORTE_ELIMINADO.
	 */
	SOPORTE_ELIMINADO("eliminar.soporte.desistimiento");
	 ...
	 */
	public static final String NOMBRE_BUNDLE = "mensajes.mensajes_desistimiento_%s";

	/**
	 * Construye una nueva instancia/objeto de la clase EnumMensajesDesistimientos.
	 *
	 * @param as_codigo el parametro codigo
	 */
	private EnumMensajesDesistimientos(String as_codigo) {
