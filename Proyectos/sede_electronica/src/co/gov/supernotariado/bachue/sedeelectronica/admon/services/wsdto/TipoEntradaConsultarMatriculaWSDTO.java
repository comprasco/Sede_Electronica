 ...
 * --------------------------------------
 * Nombre del archivo: TipoEntradaConsultarMatriculaWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoEntradaConsultarMatriculaWSDTO
 ...
 * @version 1.0
 */
public class TipoEntradaConsultarMatriculaWSDTO extends GenericoDTO{
