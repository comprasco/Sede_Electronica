 ...
 * --------------------------------------
 * Nombre del archivo: TipoUsuarioIUIWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoUsuarioIUIWSDTO
 ...
 * <br>
 * Contiene propiedades para representar los datos del objeto Tipo usuario IUI.
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoUsuarioIUIWSDTO implements Serializable{
