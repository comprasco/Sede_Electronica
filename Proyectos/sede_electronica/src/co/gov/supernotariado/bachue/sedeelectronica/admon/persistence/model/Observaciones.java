 ...
 * datos.<br>
 * Esta clase representa la entidad <b>Observaciones</b>, <br>
 * que permite la persistencia en la tabla
 * <b>SDB_BGN_OBSERVACIONES_ENTIDAD_ESPECIAL</b> de la base de datos.
 * 
 * <br>
 ...
 */
@Entity
@Table(name="SDB_BGN_OBSERVACIONES_ENTIDAD_ESPECIAL")
@NamedQuery(name="Observaciones.findAll", query="SELECT s FROM Observaciones s")
public class Observaciones implements Serializable {
	...
	/**
	 * Atributo para definir la propiedad observacion.
	 */
	...
	/**
	 * Construye una nueva instancia/objeto de la clase Observaciones.
	 */
	 ...
	 *
	 * @param observacion el nuevo valor para la propiedad observacion
	 */
