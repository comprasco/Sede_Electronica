 ...
 * --------------------------------------
 * Nombre del archivo: TipoEntradaConsultarAlertasWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoEntradaConsultarAlertasWSDTO
 ...
 * @version 1.0
 */
public class TipoEntradaConsultarAlertasWSDTO extends GenericoDTO {
