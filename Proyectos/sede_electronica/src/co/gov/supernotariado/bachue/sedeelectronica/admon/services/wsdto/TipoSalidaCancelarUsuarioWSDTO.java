 ...
 * --------------------------------------
 * Nombre del archivo: TipoSalidaCancelarUsuarioWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoSalidaCancelarUsuarioWSDTO
 ...
 * @version 1.0
 */
public class TipoSalidaCancelarUsuarioWSDTO extends GenericoDTO{
