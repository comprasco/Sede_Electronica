...
/**
 * Enumeracion para definir el grupo de constantes para Mensajes Prorroga.
 * <br>
 ...
 * @version 1.0
 */
public enum EnumMensajesProrroga implements IEnumCatalogoMensajes {
	 ...
	 */
	TRANSACCION_DESCARTADA("eliminar.transaccion.prorroga"),
	/**
	 * Constante de la enumeracion para definir el item: SOPORTE_ELIMINADO.
	 */
	SOPORTE_ELIMINADO("eliminar.soporte.prorroga");
	 ...
	 */
	public static final String CS_NOMBRE_BUNDLE = "mensajes.mensajes_prorriga_%s";

	/**
	 * Construye una nueva instancia/objeto de la clase EnumMensajesProrroga.
	 *
	 * @param as_codigo el parametro codigo
	 */
	private EnumMensajesProrroga(String as_codigo) {
