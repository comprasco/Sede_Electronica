 ...
 * @version 1.0
 */
public class TipoSalidaConsultaActosTurnoWSDTO extends GenericoDTO implements ISalidaServicioWSDTO{
	...
	private static final long serialVersionUID = 1L;
	    ...
	    private List<ActoWSDTO> ila_actos; 
		...
		public List<ActoWSDTO> getIla_actos() {
			return ila_actos;
		}
		public void setIla_actos(List<ActoWSDTO> ala_actos) {
