 ...
 * --------------------------------------
 * Nombre del archivo: TipoEntradaObtenerPDFLiquidacionWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoEntradaObtenerPDFLiquidacionWSDTO
 ...
 * @version 1.0
 */
public class TipoEntradaObtenerPDFLiquidacionWSDTO extends GenericoDTO {
