 ...
 * datos.<br>
 * Esta clase representa la entidad <b>Historico clave</b>, <br>
 * que permite la persistencia en la tabla <b>SDB_AUT_HISTORICO_CLAVE</b> de la
 * base de datos.
 * 
 * <br>
 ...
 */
@Entity
@Table(name = "SDB_AUT_HISTORICO_CLAVE")
@NamedQueries( value = {
	@NamedQuery(name = "HistoricoClave.findAll", query = "SELECT s FROM HistoricoClave s"),
	@NamedQuery(name = "HistoricoClave.findByUsuario", query = "SELECT hc FROM HistoricoClave hc WHERE hc.usuario = :usuario ORDER BY hc.fechaModificacion DESC")
})
public class HistoricoClave implements Serializable {
	 ...
	 */
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEC_AUT_HISTORICO_CLAVE_ID_GENERATOR")
	@SequenceGenerator(sequenceName = "SEC_AUT_HISTORICO_CLAVE",allocationSize = 1,name = "SEC_AUT_HISTORICO_CLAVE_ID_GENERATOR")
	private String id;
	...
	/**
	 * Construye una nueva instancia/objeto de la clase HistoricoClave.
	 */
