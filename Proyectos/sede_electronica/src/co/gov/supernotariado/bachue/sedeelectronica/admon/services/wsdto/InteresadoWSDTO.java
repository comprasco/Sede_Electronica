 ...
 * --------------------------------------
 * Nombre del archivo: InteresadoWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: InteresadoWSDTO
 ...
 * <br>
 * Contiene propiedades para representar los datos del objeto Interesado.
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class InteresadoWSDTO implements Serializable{
