 ...
 * datos.<br>
 * Esta clase representa la entidad <b>Formulario usuario</b>, <br>
 * que permite la persistencia en la tabla <b>SDB_ACC_FORMULARIO_USUARIO</b> de
 * la base de datos.
 * 
 * <br>
 ...
 */
@Entity
@Table(name = "SDB_ACC_FORMULARIO_USUARIO")
@NamedQueries(value = { @NamedQuery(name = "FormularioUsuario.findAll", query = "SELECT s FROM FormularioUsuario s"),
		@NamedQuery(name = "FormularioUsuario.consultarPorUsuarioYFormulario", query = "Select s from FormularioUsuario s WHERE s.configuracionFormulario = :idConfiguracionFormulario AND s.idUsuario = :idUsuario AND s.activo = :activo"), })
public class FormularioUsuario implements Serializable {
	 ...
	 */
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEC_ACC_FORMULARIO_USUARIO")
	@SequenceGenerator(sequenceName = "SEC_ACC_FORMULARIO_USUARIO", allocationSize = 1, name = "SEC_ACC_FORMULARIO_USUARIO")
	private String id;
	...
	/**
	 * Atributo para definir la propiedad valor campo formulario.
	 */
	@OneToMany(mappedBy = "idFormularioUsuario")
	private List<ValorCampoFormulario> valorCampoFormulario;
	
	/**
	 * Construye una nueva instancia/objeto de la clase FormularioUsuario.
	 */
	 ...
	 * Construye una nueva instancia/objeto de la clase FormularioUsuario.
	 *
	 * @param as_idFormularioUsuario el parametro id formulario usuario
	 */
	public FormularioUsuario(String as_idFormularioUsuario) {
		this.id = as_idFormularioUsuario;
	}
	...
	/**
	 * Obtiene el valor para la propiedad valor campo formulario.
	 *
	 * @return El valor de la propiedad valor campo formulario
	 */
	public List<ValorCampoFormulario> getValorCampoFormulario() {
		return valorCampoFormulario;
	}

	/**
	 * Cambia/actualiza el valor para la propiedad valor campo formulario.
	 *
	 * @param valorCampoFormulario el nuevo valor para la propiedad valor campo
	 *                             formulario
	 */
	public void setValorCampoFormulario(List<ValorCampoFormulario> valorCampoFormulario) {
		this.valorCampoFormulario = valorCampoFormulario;
	}
