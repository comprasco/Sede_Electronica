 ...
 * --------------------------------------
 * Nombre del archivo: EntradaAceptacionTransaccionWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.pasarelarealpay.wsdto
 * Nombre del elemento: EntradaAceptacionTransaccionWSDTO
 ...
 * <br>
 * Contiene propiedades para representar los datos del objeto Entrada aceptacion
 * transaccion. <br>
 ...
 * @version 1.0
 */
public class EntradaAceptacionTransaccionWSDTO extends EntradaGenericaAutenticacionActivaWSDTO {
	 ...
	 * EntradaAceptacionTransaccionWSDTO.
	 */
	public EntradaAceptacionTransaccionWSDTO() {
		//Metodo contructor
	}
}
