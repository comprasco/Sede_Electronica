 ...
 * datos.<br>
 * Esta clase representa la entidad <b>Tipo estado cuenta</b>, <br>
 * que permite la persistencia en la tabla <b>SDB_AUT_TIPO_ESTADO_CUENTA</b> de
 * la base de datos.
 * 
 * <br>
 ...
 */
@Entity
@Table(name = "SDB_AUT_TIPO_ESTADO_CUENTA")
@NamedQuery(name = "TipoEstadoCuenta.findAll", query = "SELECT s FROM TipoEstadoCuenta s")
public class TipoEstadoCuenta implements Serializable {
	...
	@OneToMany(mappedBy = "tipoEstadoCuenta")
	private List<Usuario> usuarios;

	/**
	 * Construye una nueva instancia/objeto de la clase TipoEstadoCuenta.
	 */
	public TipoEstadoCuenta() {
		super();
	}
	...
	public Usuario addUsuario(Usuario usuario) {
		...
		usuario.setTipoEstadoCuenta(this);
	...
	public Usuario removeUsuario(Usuario usuario) {
		...
		usuario.setTipoEstadoCuenta(null);
