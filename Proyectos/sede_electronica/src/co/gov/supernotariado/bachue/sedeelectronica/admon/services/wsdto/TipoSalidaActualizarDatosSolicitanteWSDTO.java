 ...
 * --------------------------------------
 * Nombre del archivo: TipoSalidaActualizarDatosSolicitanteWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoSalidaActualizarDatosSolicitanteWSDTO
 ...
 * @version 1.0
 */
public class TipoSalidaActualizarDatosSolicitanteWSDTO extends GenericoDTO{
