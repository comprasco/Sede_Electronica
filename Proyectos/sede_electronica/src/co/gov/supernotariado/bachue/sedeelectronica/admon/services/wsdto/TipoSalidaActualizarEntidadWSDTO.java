 ...
 * --------------------------------------
 * Nombre del archivo: TipoSalidaActualizarEntidadWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoSalidaActualizarEntidadWSDTO
 ...
 * @version 1.0
 */
public class TipoSalidaActualizarEntidadWSDTO extends GenericoDTO{
