 ...
 * --------------------------------------
 * Nombre del archivo: TipoEntradaCrearProcAntiguoSistemaTierrasWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoEntradaCrearProcAntiguoSistemaTierrasWSDTO
 ...
 * <br>
 * Contiene propiedades para representar los datos del objeto Tipo entrada crear
 * proc antiguo sistema tierras.
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoEntradaCrearProcAntiguoSistemaTierrasWSDTO extends GenericoDTO {
