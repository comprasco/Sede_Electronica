...
/**
 * Enumeracion para definir el grupo de constantes para Mensajes correcciones.
 * <br>
 ...
 * @version 1.0
 */
public enum EnumMensajesCorrecciones implements IEnumCatalogoMensajes {
	...
	/**
	 * Constante de la enumeracion para definir el item: TIPO_CORRECCION_GUARDADO.
	 */
	 ...
	 */
	public static final String NOMBRE_BUNDLE = "mensajes.mensajes_correcciones_%s";
	 ...
	 */
	private EnumMensajesCorrecciones(String as_codigo) {
