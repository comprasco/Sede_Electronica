 ...
 */
@Local
public interface ISolicitudCorreccionesBusiness {
	...
	/**
	 * Metodo que se encarga de llamar a la operacion obtener causales correccion en
	 * el servicio de solicitud correccion.
	 *
	 * @return Resultado para obtener causales correccion retornado como
	 *         TipoSalidaObtenerCausalesCorreccionWSDTO
	 */
