 ...
 * --------------------------------------
 * Nombre del archivo: TipoUsuarioCUOWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoUsuarioCUOWSDTO
 ...
 * <br>
 * Contiene propiedades para representar los datos del objeto Tipo usuario CUO.
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoUsuarioCUOWSDTO implements Serializable{
