 ...
 * --------------------------------------
 * Nombre del archivo: TipoServicioGLOWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoServicioGLOWSDTO
 ...
 * <br>
 * Contiene propiedades para representar los datos del objeto Tipo servicio GLO.
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoServicioGLOWSDTO implements Serializable{
