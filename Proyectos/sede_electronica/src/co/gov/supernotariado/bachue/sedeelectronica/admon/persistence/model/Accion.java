 ...
 * datos.<br>
 * Esta clase representa la entidad <b>Accion</b>, <br>
 * que permite la persistencia en la tabla <b>SDB_ACC_ACCION</b> de la base de
 * datos.
 * 
 * <br>
...
@Entity
@Table(name = "SDB_ACC_ACCION")
@NamedQuery(name = "Accion.findAll", query = "SELECT s FROM Accion s")
public class Accion implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "SDB_ACC_ACCION_ID_GENERATOR", sequenceName = "SECUENCES")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SDB_ACC_ACCION_ID_GENERATOR")
	private String id;
	...
	/**
	 * Construye una nueva instancia/objeto de la clase Accion.
	 */
	public Accion() {
