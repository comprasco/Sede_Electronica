 ...
 * --------------------------------------
 * Nombre del archivo: TipoEntradaConsultarEstadoLiquidacionWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoEntradaConsultarEstadoLiquidacionWSDTO
 ...
 * @version 1.0
 */
public class TipoEntradaConsultarEstadoLiquidacionWSDTO extends GenericoDTO{
