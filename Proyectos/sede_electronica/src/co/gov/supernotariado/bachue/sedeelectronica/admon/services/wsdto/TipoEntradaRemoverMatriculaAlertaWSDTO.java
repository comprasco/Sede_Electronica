 ...
 * --------------------------------------
 * Nombre del archivo: TipoEntradaRemoverMatriculaAlertaWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoEntradaRemoverMatriculaAlertaWSDTO
 ...
 * @version 1.0
 */
public class TipoEntradaRemoverMatriculaAlertaWSDTO extends GenericoDTO 
{
