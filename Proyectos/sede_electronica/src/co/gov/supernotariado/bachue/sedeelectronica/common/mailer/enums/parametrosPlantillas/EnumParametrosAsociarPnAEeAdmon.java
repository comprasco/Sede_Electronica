 ...
 * --------------------------------------
 * Nombre del archivo: EnumParametrosAsociarPnAEeAdmon.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.common.mailer.enums.parametrosPlantillas
 * Nombre del elemento: EnumParametrosAsociarPnAEeAdmon
 ...
 * estidad especial admon.
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public enum EnumParametrosAsociarPnAEeAdmon {
	 ...
	 * EnumParametrosAsociarPnAEeAdmon.
	 *
	 * @param as_codigoPlanilla el parametro codigo planilla
	 */
	private EnumParametrosAsociarPnAEeAdmon(String as_codigoPlanilla) {
