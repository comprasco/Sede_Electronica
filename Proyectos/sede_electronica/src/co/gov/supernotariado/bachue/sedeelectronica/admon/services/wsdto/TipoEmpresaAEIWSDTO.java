 ...
 * --------------------------------------
 * Nombre del archivo: TipoEmpresaAEIWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoEmpresaAEIWSDTO
 ...
 * <br>
 * Contiene propiedades para representar los datos del objeto Tipo empresa AEI.
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoEmpresaAEIWSDTO implements Serializable{
