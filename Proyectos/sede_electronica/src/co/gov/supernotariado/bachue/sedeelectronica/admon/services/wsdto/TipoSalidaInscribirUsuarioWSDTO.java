 ...
 * --------------------------------------
 * Nombre del archivo: TipoSalidaInscribirUsuarioWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoSalidaInscribirUsuarioWSDTO
 ...
 * @version 1.0
 */
public class TipoSalidaInscribirUsuarioWSDTO extends GenericoDTO{
