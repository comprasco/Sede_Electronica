 ...
 * --------------------------------------
 * Nombre del archivo: MedidasCautelaresWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: MedidasCautelaresWSDTO
 ...
 * <br>
 * Contiene propiedades para representar los datos del objeto Medidas
 * cautelares.
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class MedidasCautelaresWSDTO extends GenericoDTO 
{
