 ...
 * datos.<br>
 * Esta clase representa la entidad <b>Tipo documento</b>, <br>
 * que permite la persistencia en la tabla <b>SDB_PGN_TIPO_DOCUMENTO</b> de la
 * base de datos.
 * 
 * <br>
 ...
 */
@Entity
@Table(name = "SDB_PGN_TIPO_DOCUMENTO")
...
public class TipoDocumento implements Serializable {
	...
	/**
	 * Atributo para definir la propiedad sdb aut personas.
	 */
	// bi-directional many-to-one association to Persona
	@OneToMany(mappedBy = "tipoDocumento")
	private List<Persona> sdbAutPersonas;

	/**
	 * Construye una nueva instancia/objeto de la clase TipoDocumento.
	 */
	...
	public List<Persona> getPersonas() {
		return this.sdbAutPersonas;
	}

	/**
	 * Cambia/actualiza el valor para la propiedad personas.
	 *
	 * @param sdbAutPersonas el nuevo valor para la propiedad personas
	 */
	public void setPersonas(List<Persona> sdbAutPersonas) {
		this.sdbAutPersonas = sdbAutPersonas;
	}

	/**
	 * Agrega el/la persona.
	 *
	 * @param sdbAutPersona el parametro sdb aut persona
	 * @return Resultado para Agrega el/la persona retornado como Persona
	 */
	public Persona addPersona(Persona sdbAutPersona) {
		getPersonas().add(sdbAutPersona);
		sdbAutPersona.setTipoDocumento(this);

		return sdbAutPersona;
	}
	 ...
	 */
	public Persona removePersona(Persona sdbAutPersona) {
		getPersonas().remove(sdbAutPersona);
		sdbAutPersona.setTipoDocumento(null);
