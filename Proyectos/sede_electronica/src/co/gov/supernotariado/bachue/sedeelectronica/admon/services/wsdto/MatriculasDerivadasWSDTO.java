 ...
 * --------------------------------------
 * Nombre del archivo: MatriculasDerivadasWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: MatriculasDerivadasWSDTO
 ...
 * <br>
 * Contiene propiedades para representar los datos del objeto Matriculas
 * derivadas.
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class MatriculasDerivadasWSDTO extends GenericoDTO 
{
