 ...
 * --------------------------------------
 * Nombre del archivo: ListaMatriculasConsultarMatriculaFiltrosTierrasWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: ListaMatriculasConsultarMatriculaFiltrosTierrasWSDTO
 ...
 * @version 1.0
 */
public class ListaMatriculasConsultarMatriculaFiltrosTierrasWSDTO implements Serializable{
