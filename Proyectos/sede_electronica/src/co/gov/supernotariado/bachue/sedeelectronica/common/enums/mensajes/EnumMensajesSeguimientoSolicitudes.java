 ...
 * --------------------------------------
 * Nombre del archivo: EnumMensajesSeguimientoSolicitudes.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.common.enums.mensajes
 * Nombre del elemento: EnumMensajesSeguimientoSolicitudes
...
/**
 * Enumeracion para definir el grupo de constantes para Mensajes seguimiento
 * solicitudes. <br>
 ...
 * @version 1.0
 */
public enum EnumMensajesSeguimientoSolicitudes implements IEnumCatalogoMensajes {

	// Enum que aloja nombre del archivo que contiene las propiedades y un codigo
	// que representa el mensaje existente

	/**
	 * Constante de la enumeracion para definir el item: DATOS_NO_ENCONTRADOS.
	 */
	DATOS_NO_ENCONTRADOS("mensajes.datos.no.encontrados.validacion"),

	/**
	 * Constante de la enumeracion para definir el item: DATOS_ENCONTRADOS.
	 */
	DATOS_ENCONTRADOS("mensajes.datos.encontrados.validacion");
	 ...
	 */
	public static final String NOMBRE_BUNDLE = "mensajes.mensajes_seguimiento_solicitudes_%s";

	/**
	 * Construye una nueva instancia/objeto de la clase
	 * EnumMensajesSeguimientoSolicitudes.
	 *
	 * @param as_codigo el parametro codigo
	 */
	private EnumMensajesSeguimientoSolicitudes(String as_codigo) {
