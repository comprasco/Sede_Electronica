 ...
 * datos.<br>
 * Esta clase representa la entidad <b>Letra eje</b>, <br>
 * que permite la persistencia en la tabla <b>SDB_PNG_LETRA_EJE</b> de la base
 * de datos.
 * 
 * <br>
...
@Table(name = "SDB_PNG_LETRA_EJE")
@NamedQueries( value ={ @NamedQuery(name = "LetraEje.findAll", query = "SELECT s FROM LetraEje s"), })
public class LetraEje implements Serializable{
	...
	/**
	 * Atributo para definir la propiedad letra.
	 */
	@Column(name = "LETRA")
	 ...
	 *
	 * @param letra el nuevo valor para la propiedad letra
	 */
