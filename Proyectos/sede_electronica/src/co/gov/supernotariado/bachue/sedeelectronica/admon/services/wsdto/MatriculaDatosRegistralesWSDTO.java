 ...
 * --------------------------------------
 * Nombre del archivo: MatriculaDatosRegistralesWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: MatriculaDatosRegistralesWSDTO
 ...
 * <br>
 * Contiene propiedades para representar los datos del objeto Matricula datos
 * registrales.
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class MatriculaDatosRegistralesWSDTO implements Serializable{
    ...
    /**
	 * Atributo de instancia tipo lista de TitularWSDTO para definir la propiedad
	 * titulares.
	 */
    private List<TitularWSDTO> ilt_titulares;
    
    /**
	 * Atributo de instancia tipo lista de AnotacionWSDTO para definir la propiedad
	 * anotaciones.
	 */
    private List<AnotacionWSDTO> ila_anotaciones;
	 ...
	 */
	public List<TitularWSDTO> getIlt_titulares() {
	 ...
	 */
	public void setIlt_titulares(List<TitularWSDTO> alt_titulares) {
	 ...
	 */
	public List<AnotacionWSDTO> getIla_anotaciones() {
	 ...
	 */
	public void setIla_anotaciones(List<AnotacionWSDTO> ala_anotaciones) {
