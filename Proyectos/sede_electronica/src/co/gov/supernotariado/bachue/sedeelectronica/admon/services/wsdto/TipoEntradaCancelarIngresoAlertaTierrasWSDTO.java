 ...
 * --------------------------------------
 * Nombre del archivo: TipoEntradaCancelarIngresoAlertaTierrasWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoEntradaCancelarIngresoAlertaTierrasWSDTO
 ...
 * @version 1.0
 */
public class TipoEntradaCancelarIngresoAlertaTierrasWSDTO extends GenericoDTO {
