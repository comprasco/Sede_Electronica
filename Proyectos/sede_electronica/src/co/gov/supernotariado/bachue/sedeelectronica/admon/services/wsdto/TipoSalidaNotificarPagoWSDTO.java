 ...
 * --------------------------------------
 * Nombre del archivo: TipoSalidaNotificarPagoWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoSalidaNotificarPagoWSDTO
 ...
 * @version 1.0
 */
public class TipoSalidaNotificarPagoWSDTO extends GenericoDTO {
