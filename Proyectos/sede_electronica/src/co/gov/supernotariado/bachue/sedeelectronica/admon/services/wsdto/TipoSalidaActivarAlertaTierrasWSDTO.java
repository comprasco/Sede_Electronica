 ...
 * --------------------------------------
 * Nombre del archivo: TipoSalidaActivarAlertaTierrasWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoSalidaActivarAlertaTierrasWSDTO
 ...
 * @version 1.0
 */
public class TipoSalidaActivarAlertaTierrasWSDTO extends GenericoDTO implements ISalidaServicioWSDTO {
