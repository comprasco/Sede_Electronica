 ...
 * --------------------------------------
 * Nombre del archivo: TipoSalidaEliminarProcAntiguoSistemaWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoSalidaEliminarProcAntiguoSistemaWSDTO
 ...
 * @version 1.0
 */
public class TipoSalidaEliminarProcAntiguoSistemaWSDTO extends GenericoDTO implements ISalidaServicioWSDTO {
