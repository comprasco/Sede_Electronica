 ...
 * --------------------------------------
 * Nombre del archivo: TipoSalidaAgregarListaMatriculasAlertaWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoSalidaAgregarListaMatriculasAlertaWSDTO
 ...
 * @version 1.0
 */
public class TipoSalidaAgregarListaMatriculasAlertaWSDTO extends GenericoDTO implements ISalidaServicioWSDTO {
