 ...
 * --------------------------------------
 * Nombre del archivo: TipoParametroWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoParametroWSDTO
 ...
 * <br>
 * Contiene propiedades para representar los datos del objeto Tipo parametro.
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoParametroWSDTO implements Serializable
{
