 ...
 * --------------------------------------
 * Nombre del archivo: ParametroBusquedaDocumentoWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: ParametroBusquedaDocumentoWSDTO
 ...
 * <br>
 * Contiene propiedades para representar los datos del objeto Parametro busqueda
 * documento.
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class ParametroBusquedaDocumentoWSDTO implements Serializable{
