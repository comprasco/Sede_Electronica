 ...
 * --------------------------------------
 * Nombre del archivo: EnumMensajesServicioRegistral.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.common.enums.mensajes
 * Nombre del elemento: EnumMensajesServicioRegistral
...
/**
 * Enumeracion para definir el grupo de constantes para Mensajes servicio registral.
 * <br>
 ...
 * @version 1.0
 */
public enum EnumMensajesServicioRegistral implements IEnumCatalogoMensajes {

	// Enum que aloja nombre del archivo que contiene las propiedades y un codigo
	/**
	 * Constante de la enumeracion para definir el item: TRANSACCION_ELIMINADA.
	 */
	// que representa el mensaje existente
	TRANSACCION_ELIMINADA("transaccion.eliminada"),
	;
	 ...
	 */
	public static final String NOMBRE_BUNDLE = "mensajes.mensajes_servicio_registral_%s";

	/**
	 * Construye una nueva instancia/objeto de la clase EnumMensajesServicioRegistral.
	 *
	 * @param as_codigo el parametro codigo
	 */
	private EnumMensajesServicioRegistral(String as_codigo) {
