 ...
 * --------------------------------------
 * Nombre del archivo: EnumParametrosRechazoPersonaJuridica.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.common.mailer.enums.parametrosPlantillas
 * Nombre del elemento: EnumParametrosRechazoPersonaJuridica
...
/**
 * Enumeracion para definir el grupo de constantes para Parametros rechazo
 * persona juridica.
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public enum EnumParametrosRechazoPersonaJuridica {
	 ...
	 * EnumParametrosRechazoPersonaJuridica.
	 *
	 * @param as_codigoPlanilla el parametro codigo planilla
	 */
	private EnumParametrosRechazoPersonaJuridica(String as_codigoPlanilla) {
