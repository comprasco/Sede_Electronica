 ...
 * datos.<br>
 * Esta clase representa la entidad <b>Tipo acto</b>, <br>
 * que permite la persistencia en la tabla <b>SDB_ACC_TIPO_ACTO</b> de la base
 * de datos.
 * 
 * <br>
 ...
 */
@Entity
@Table(name = "SDB_ACC_TIPO_ACTO")
@NamedQuery(name = "TipoActo.findAll", query = "SELECT s FROM TipoActo s")
public class TipoActo implements Serializable {
	 ...
	 */
	// bi-directional many-to-one association to SdbAccModeloMinutaActo
	@OneToMany(mappedBy = "tipoActo")
	private List<ModeloMinutaActo> modeloMinutaActos;

	/**
	 * Construye una nueva instancia/objeto de la clase TipoActo.
	 */
	public TipoActo() {
		//Contructor para modelo de persistencia para TipoActo
	}
