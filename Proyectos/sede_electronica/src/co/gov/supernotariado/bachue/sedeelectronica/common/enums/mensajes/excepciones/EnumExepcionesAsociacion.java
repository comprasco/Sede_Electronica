...
/**
 * Enumeracion para definir el grupo de constantes para Exepciones asociacion.
 * <br>
 ...
 * @version 1.0
 */
public enum EnumExepcionesAsociacion implements IEnumCatalogoMensajes {

	/**
	 * Constante de la enumeracion para definir el item: ASOCIACION_EXISTENTE.
	 */
	ASOCIACION_EXISTENTE("asociacion.existente");
	 ...
	 */
	public static final String NOMBRE_BUNDLE = "excepciones.excepcion_asociacion_%s";
	...
	/**
	 * Construye una nueva instancia/objeto de la clase EnumExepcionesAsociacion.
	 *
	 * @param as_codigoError el parametro codigo error
	 */
	private EnumExepcionesAsociacion(String as_codigoError) {
