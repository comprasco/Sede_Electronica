 ...
 * --------------------------------------
 * Nombre del archivo: PropietariosWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: PropietariosWSDTO
 ...
 * <br>
 * Contiene propiedades para representar los datos del objeto Propietarios.
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class PropietariosWSDTO extends GenericoDTO
{
