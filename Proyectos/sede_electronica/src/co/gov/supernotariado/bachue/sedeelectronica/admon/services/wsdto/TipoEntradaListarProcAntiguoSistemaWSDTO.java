 ...
 * --------------------------------------
 * Nombre del archivo: TipoEntradaListarProcAntiguoSistemaWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoEntradaListarProcAntiguoSistemaWSDTO
 ...
 * @version 1.0
 */
public class TipoEntradaListarProcAntiguoSistemaWSDTO extends GenericoDTO 
{
