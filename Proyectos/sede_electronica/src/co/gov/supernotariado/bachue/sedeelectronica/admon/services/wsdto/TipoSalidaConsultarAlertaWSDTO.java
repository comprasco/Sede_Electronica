 ...
 * --------------------------------------
 * Nombre del archivo: TipoSalidaConsultarAlertaWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoSalidaConsultarAlertaWSDTO
 ...
 * @version 1.0
 */
public class TipoSalidaConsultarAlertaWSDTO extends GenericoDTO implements ISalidaServicioWSDTO
{
