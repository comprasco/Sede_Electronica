 ...
 * --------------------------------------
 * Nombre del archivo: TurnoConsultarDetallesSolicitudWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TurnoConsultarDetallesSolicitudWSDTO
 ...
 * <br>
 * Contiene propiedades para representar los datos del objeto Turno consultar
 * detalles solicitud.
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TurnoConsultarDetallesSolicitudWSDTO implements Serializable{
