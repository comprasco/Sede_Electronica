 ...
 * --------------------------------------
 * Nombre del archivo: HistoricoTransaccionesDescartadas.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.persistence.model
 * Nombre del elemento: HistoricoTransaccionesDescartadas
 ...
 * datos.<br>
 * Esta clase representa la entidad <b>Historico transacciones descartadas</b>,
 * <br>
 * que permite la persistencia en la tabla
 * <b>SDB_AUT_HISTORICO_TRANSACCIONES_DESCARTADAS</b> de la base de datos.
 * 
 * <br>
 ...
 */
@Entity
@Table(name = "SDB_AUT_HISTORICO_TRANSACCIONES_DESCARTADAS")
@NamedQuery(name = "HistoricoTransaccionesDescartadas.findAll", query = "SELECT s FROM HistoricoTransaccionesDescartadas s")
public class HistoricoTransaccionesDescartadas implements Serializable {
	 ...
	 */
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEC_AUT_HISTORICO_TRANSACCIONES_DESCARTADAS")
	@SequenceGenerator(name = "SEC_AUT_HISTORICO_TRANSACCIONES_DESCARTADAS", sequenceName = "SEC_AUT_HISTORICO_TRANSACCIONES_DESCARTADAS", allocationSize = 1)
	private String id;
	...
	/**
	 * Atributo para definir la propiedad motivo.
	 */
	@Column(name = "MOTIVO")
	...
	/**
	 * Atributo para definir la propiedad ultimo estado transaccion.
	 */
	@Column(name = "ULTIMO_ESTADO_TRANSACCION")
	private String ultimoEstadoTransaccion;

	/**
	 * Construye una nueva instancia/objeto de la clase
	 * HistoricoTransaccionesDescartadas.
	 */
	public HistoricoTransaccionesDescartadas() {
		// Constructor vacio
	}
	 ...
	 *
	 * @param motivo el nuevo valor para la propiedad motivo
	 */
	 ...
	 */
	public String getUltimoEstadoTransaccion() {
		return ultimoEstadoTransaccion;
	}

	/**
	 * Cambia/actualiza el valor para la propiedad ultimo estado transaccion.
	 *
	 * @param ultimoEstadoTransaccion el nuevo valor para la propiedad ultimo estado
	 *                                transaccion
	 */
	public void setUltimoEstadoTransaccion(String ultimoEstadoTransaccion) {
		this.ultimoEstadoTransaccion = ultimoEstadoTransaccion;
	}
