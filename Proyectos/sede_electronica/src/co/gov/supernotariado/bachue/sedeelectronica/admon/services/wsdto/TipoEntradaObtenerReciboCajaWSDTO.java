 ...
 * --------------------------------------
 * Nombre del archivo: TipoEntradaObtenerReciboCajaWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoEntradaObtenerReciboCajaWSDTO
 ...
 * @version 1.0
 */
public class TipoEntradaObtenerReciboCajaWSDTO extends GenericoDTO 
{
