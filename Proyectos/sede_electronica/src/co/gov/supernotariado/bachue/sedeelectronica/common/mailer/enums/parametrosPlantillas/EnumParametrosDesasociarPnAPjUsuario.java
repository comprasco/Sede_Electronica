 ...
 * --------------------------------------
 * Nombre del archivo: EnumParametrosDesasociarPnAPjUsuario.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.common.mailer.enums.parametrosPlantillas
 * Nombre del elemento: EnumParametrosDesasociarPnAPjUsuario
 ...
 * A persona juridica usuario.
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public enum EnumParametrosDesasociarPnAPjUsuario {
	 ...
	 * EnumParametrosDesasociarPnAPjUsuario.
	 *
	 * @param as_codigoPlanilla el parametro codigo planilla
	 */
	private EnumParametrosDesasociarPnAPjUsuario(String as_codigoPlanilla) {
