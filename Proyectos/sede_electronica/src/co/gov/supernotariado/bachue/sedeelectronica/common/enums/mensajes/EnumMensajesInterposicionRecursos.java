 ...
 * --------------------------------------
 * Nombre del archivo: EnumMensajesInterposicionRecursos.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.common.enums.mensajes
 * Nombre del elemento: EnumMensajesInterposicionRecursos
...
/**
 * Enumeracion para definir el grupo de constantes para Mensajes intersposicion recursos.
 * <br>
 ...
 * @version 1.0
 */
public enum EnumMensajesInterposicionRecursos implements IEnumCatalogoMensajes {
	 ...
	 */
	public static final String NOMBRE_BUNDLE = "mensajes.mensajes_interposicion_recursos_%s";

	/**
	 * Construye una nueva instancia/objeto de la clase EnumMensajesInterposicionRecursos.
	 *
	 * @param as_codigo el parametro codigo
	 */
	private EnumMensajesInterposicionRecursos(String as_codigo) {
