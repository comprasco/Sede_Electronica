 ...
 * --------------------------------------
 * Nombre del archivo: TipoSalidaValidarSolicitudAlertaMasivaWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoSalidaValidarSolicitudAlertaMasivaWSDTO
 ...
 * @version 1.0
 */
public class TipoSalidaValidarSolicitudAlertaMasivaWSDTO extends GenericoDTO implements ISalidaServicioWSDTO{
