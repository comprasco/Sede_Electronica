 ...
 * --------------------------------------
 * Nombre del archivo: TipoUsuarioCNUIWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoUsuarioCNUIWSDTO
 ...
 * <br>
 * Contiene propiedades para representar los datos del objeto Tipo usuario CNUI.
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoUsuarioCNUIWSDTO implements Serializable{
