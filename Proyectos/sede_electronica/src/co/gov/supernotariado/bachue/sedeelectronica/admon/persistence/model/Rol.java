 ...
 * datos.<br>
 * Esta clase representa la entidad <b>Rol</b>, <br>
 * que permite la persistencia en la tabla <b>SDB_AUT_ROL</b> de la base de
 * datos.
 * 
 * <br>
...
public class Rol implements Serializable {
	 ...
	 */
	@Id	
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEC_AUT_ROL_ID_GENERATOR")
	@SequenceGenerator(sequenceName = "SEC_AUT_ROL", allocationSize = 1, name = "SEC_AUT_ROL_ID_GENERATOR")
	@Column(name= "ID")
	private String id;
	...
	/**
	 * Construye una nueva instancia/objeto de la clase Rol.
	 */
	public Rol() {
	 ...
	 *
	 * @param usuarioRols el parametro usuario rols
	 * @return Resultado para Agrega el/la usuario rol retornado como UsuarioRol
	 */
	public UsuarioRol addUsuarioRol(UsuarioRol usuarioRols) {
		getUsuarioRols().add(usuarioRols);
		usuarioRols.setRol(this);
	 ...
	 */
	public UsuarioRol removeUsuarioRol(UsuarioRol usuarioRols) {
		getUsuarioRols().remove(usuarioRols);
		usuarioRols.setRol(null);
