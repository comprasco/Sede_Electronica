 ...
 * --------------------------------------
 * Nombre del archivo: TipoEntradaDatosBasicosMatriculaWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoEntradaDatosBasicosMatriculaWSDTO
 ...
 * <br>
 * Contiene propiedades para representar los datos del objeto Tipo entrada datos
 * basicos matricula.
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class TipoEntradaDatosBasicosMatriculaWSDTO extends GenericoDTO{
