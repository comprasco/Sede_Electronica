 ...
 * --------------------------------------
 * Nombre del archivo: DetalleAlertaProcesoASDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.persistence.dto
 * Nombre del elemento: DetalleAlertaProcesoASDTO
 ...
 * <br>
 * Contiene propiedades para representar los datos del objeto Detalle alerta
 * proceso AS.
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class DetalleAlertaProcesoASDTO implements Serializable {
