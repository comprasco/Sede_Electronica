 ...
 * --------------------------------------
 * Nombre del archivo: HistorialSolicitudRegistro.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.persistence.model
 * Nombre del elemento: HistorialSolicitudRegistro
 ...
 * datos.<br>
 * Esta clase representa la entidad <b>Historial solicitud registro</b>, <br>
 * que permite la persistencia en la tabla
 * <b>SDB_AUT_HISTORIAL_SOLICITUD_REGISTRO</b> de la base de datos.
 * 
 * <br>
 ...
 */
@Entity
@Table(name="SDB_AUT_HISTORIAL_SOLICITUD_REGISTRO")

public class HistorialSolicitudRegistro implements Serializable {
	 ...
	 */
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEC_AUT_HISTORIAL_SOLICITUD_REGISTRO")
	@SequenceGenerator(sequenceName = "SEC_AUT_HISTORIAL_SOLICITUD_REGISTRO", allocationSize = 1,  name = "SEC_AUT_HISTORIAL_SOLICITUD_REGISTRO")
	private String id;
	


	/**
	 * Atributo para definir la propiedad dato solicitud registro.
	 */
	@Lob
	@Column(name="DATO_SOLICITUD_REGISTRO")
	private String datoSolicitudRegistro;
	
	/**
	 * Atributo para definir la propiedad estado solicitud.
	 */
	...
	/**
	 * Construye una nueva instancia/objeto de la clase HistorialSolicitudRegistro.
	 */
	public HistorialSolicitudRegistro() {
	 ...
	 */
	public String getDatoSolicitudRegistro() {
		return datoSolicitudRegistro;
	}

	/**
	 * Cambia/actualiza el valor para la propiedad dato solicitud registro.
	 *
	 * @param datoSolicitudRegistro el nuevo valor para la propiedad dato solicitud
	 *                              registro
	 */
	public void setDatoSolicitudRegistro(String datoSolicitudRegistro) {
		this.datoSolicitudRegistro = datoSolicitudRegistro;
	}
	 ...
	 *
	 * @param estadoSolicitud el nuevo valor para la propiedad estado solicitud
	 */
