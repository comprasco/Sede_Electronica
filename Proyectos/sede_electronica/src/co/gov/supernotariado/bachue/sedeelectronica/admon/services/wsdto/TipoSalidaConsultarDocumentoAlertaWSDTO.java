 ...
 * --------------------------------------
 * Nombre del archivo: TipoSalidaConsultarDocumentoAlertaWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoSalidaConsultarDocumentoAlertaWSDTO
 ...
 * @version 1.0
 */
public class TipoSalidaConsultarDocumentoAlertaWSDTO extends GenericoDTO implements ISalidaServicioWSDTO{
