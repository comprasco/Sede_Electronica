 ...
 * --------------------------------------
 * Nombre del archivo: TipoSalidaCancelarIngresoAlertaTierrasWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoSalidaCancelarIngresoAlertaTierrasWSDTO
 ...
 * @version 1.0
 */
public class TipoSalidaCancelarIngresoAlertaTierrasWSDTO extends GenericoDTO implements ISalidaServicioWSDTO {
