 ...
 * --------------------------------------
 * Nombre del archivo: SalidaCreacionTransaccionWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.pasarelarealpay.wsdto
 * Nombre del elemento: SalidaCreacionTransaccionWSDTO
 ...
 * <br>
 * Contiene propiedades para representar los datos del objeto Salida creacion
 * transaccion. <br>
 ...
 * @version 1.0
 */
public class SalidaCreacionTransaccionWSDTO extends GenericoBaseDTO implements Serializable{
	 ...
	 */
	public SalidaCreacionTransaccionWSDTO() {
