 ...
 * --------------------------------------
 * Nombre del archivo: MedidadCautelaresEJDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.persistence.dto
 * Nombre del elemento: MedidadCautelaresEJDTO
 ...
 * <br>
 * Contiene propiedades para representar los datos del objeto Medidad cautelares
 * EJ.
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class MedidadCautelaresEJDTO {

	/**
	 * Atributo de instancia tipo lista de String para definir la propiedad
	 * anotaciones cautelares.
	 */
	private List<String> ils_anotacionesCautelares;
	
	/**
	 * Atributo de instancia tipo lista de IntervinientesEstadoJuridicoDTO para
	 * definir la propiedad intervinientes.
	 */
	private List<IntervinientesEstadoJuridicoDTO> iliej_intervinientes;
	...
	/**
	 * Obtiene el valor para la propiedad anotaciones cautelares.
	 *
	 * @return El valor de la propiedad anotaciones cautelares
	 */
	public List<String> getIls_anotacionesCautelares() {
		return ils_anotacionesCautelares;
	}
	
	/**
	 * Cambia/actualiza el valor para la propiedad anotaciones cautelares.
	 *
	 * @param als_anotacionesCautelares el nuevo valor para la propiedad anotaciones
	 *                                  cautelares
	 */
	public void setIls_anotacionesCautelares(List<String> als_anotacionesCautelares) {
		this.ils_anotacionesCautelares = als_anotacionesCautelares;
	}
	 ...
	 */
	public List<IntervinientesEstadoJuridicoDTO> getIliej_intervinientes() {
		return iliej_intervinientes;
	}
	
	/**
	 * Cambia/actualiza el valor para la propiedad intervinientes.
	 *
	 * @param aliej_intervinientes el nuevo valor para la propiedad intervinientes
	 */
	public void setIliej_intervinientes(List<IntervinientesEstadoJuridicoDTO> aliej_intervinientes) {
		this.iliej_intervinientes = aliej_intervinientes;
	}
