...
/**
 * Enumeracion para definir el grupo de constantes para Mensajes de recepcion de
 * documentos. <br>
 ...
 * @version 1.0
 */
public enum EnumMensajesRecepcionDocumentos implements IEnumCatalogoMensajes {
	 ...
	 */
	SOPORTE_ELIMINADO("eliminar.soporte.recepcion");
	 ...
	 */
	public static final String NOMBRE_BUNDLE = "mensajes.mensajes_recepcionDocumentos_%s";

	
	
	private EnumMensajesRecepcionDocumentos(String as_codigo) {
