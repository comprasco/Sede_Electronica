 ...
 * --------------------------------------
 * Nombre del archivo: TipoSalidaNotificarDigitalizacionWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoSalidaNotificarDigitalizacionWSDTO
 ...
 * @version 1.0
 */
public class TipoSalidaNotificarDigitalizacionWSDTO extends GenericoDTO implements ISalidaServicioWSDTO
{
