 ...
 * --------------------------------------
 * Nombre del archivo: EnumMensajesConsultarAlerta.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.common.enums.mensajes
 * Nombre del elemento: EnumMensajesConsultarAlerta
...
/**
 * Enumeracion para definir el grupo de constantes para Mensajes consultar
 * alerta. <br>
 ...
 * @version 1.0
 */
public enum EnumMensajesConsultarAlerta implements IEnumCatalogoMensajes {
	 ...
	 */
	CAMPOS_VACIOS("mensajes.datoVacio.consultar");
	 ...
	 */
	public static final String NOMBRE_BUNDLE = "mensajes.mensajes_consultar_alerta_%s";

	/**
	 * Construye una nueva instancia/objeto de la clase EnumMensajesConsultarAlerta.
	 *
	 * @param as_codigo el parametro codigo
	 */
	private EnumMensajesConsultarAlerta(String as_codigo) {
