 ...
 * --------------------------------------
 * Nombre del archivo: ListaMatriculasConsultarMatriculaInfoCatastralWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: ListaMatriculasConsultarMatriculaInfoCatastralWSDTO
 ...
 * @version 1.0
 */
public class ListaMatriculasConsultarMatriculaInfoCatastralWSDTO implements Serializable{
