 ...
 * <br>
 * Contiene propiedades para representar los datos del objeto Parametro de consulta poder.
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class ParametroConsultaPoderWSDTO extends GenericoDTO{
    ...
    private String is_xTipo_Documento;
	...
	public void setIs_xNotificaciones(String is_xNotificaciones) {
		this.is_xNotificaciones = is_xNotificaciones;
	}
	public String getIs_xTipo_Documento() {
		return is_xTipo_Documento;
	}
	public void setIs_xTipo_Documento(String is_xTipo_Documento) {
		this.is_xTipo_Documento = is_xTipo_Documento;
	}
	public String getIs_dDocType() {
		return is_dDocType;
	}
	public void setIs_dDocType(String is_dDocType) {
		this.is_dDocType = is_dDocType;
	}
