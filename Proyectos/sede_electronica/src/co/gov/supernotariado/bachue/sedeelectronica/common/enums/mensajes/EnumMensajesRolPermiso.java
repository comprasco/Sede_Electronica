 ...
 * --------------------------------------
 * Nombre del archivo: EnumMensajesRolPermiso.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.common.enums.mensajes
 * Nombre del elemento: EnumMensajesRolPermiso
...
/**
 * Enumeracion para definir el grupo de constantes para Mensajes rol permiso.
 * <br>
 ...
 * @version 1.0
 */
public enum EnumMensajesRolPermiso implements IEnumCatalogoMensajes {

	// Enum que aloja nombre del archivo que contiene las propiedades y un codigo
	// que representa el mensaje existente

	/**
	 * Constante de la enumeracion para definir el item: CAMBIO_EXITOSO.
	 */
	CAMBIO_EXITOSO("cambio.exitoso"),

	/**
	 * Constante de la enumeracion para definir el item: CAMBIO_ERROR.
	 */
	CAMBIO_ERROR("cambio.error");
	 ...
	 */
	public static final String NOMBRE_BUNDLE = "mensajes.mensajes_rol_permiso_%s";

	/**
	 * Construye una nueva instancia/objeto de la clase EnumMensajesRolPermiso.
	 *
	 * @param as_codigo el parametro codigo
	 */
	private EnumMensajesRolPermiso(String as_codigo) {
