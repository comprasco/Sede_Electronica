 ...
 * --------------------------------------
 * Nombre del archivo: TipoSalidaConsultarUsuariosWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoSalidaConsultarUsuariosWSDTO
 ...
 * @version 1.0
 */
public class TipoSalidaConsultarUsuariosWSDTO extends GenericoDTO implements ISalidaServicioWSDTO{
	...
	/**
	 * Atributo de instancia tipo lista de TipoUsuarioCUSOWSDTO para definir la
	 * propiedad usuarios.
	 */
	private List<TipoUsuarioCUSOWSDTO> iltu_usuarios;
	 ...
	 */
	public List<TipoUsuarioCUSOWSDTO> getIltu_usuarios() {
	 ...
	 */
	public void setIltu_usuarios(List<TipoUsuarioCUSOWSDTO> altu_usuarios) {
