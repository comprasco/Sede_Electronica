 ...
 * --------------------------------------
 * Nombre del archivo: TipoEntradaValidarSolicitudAlertaIndividualWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoEntradaValidarSolicitudAlertaIndividualWSDTO
 ...
 * @version 1.0
 */
public class TipoEntradaValidarSolicitudAlertaIndividualWSDTO extends GenericoDTO{
