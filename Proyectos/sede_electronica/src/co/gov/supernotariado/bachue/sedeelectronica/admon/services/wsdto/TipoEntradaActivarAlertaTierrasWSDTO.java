 ...
 * --------------------------------------
 * Nombre del archivo: TipoEntradaActivarAlertaTierrasWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoEntradaActivarAlertaTierrasWSDTO
 ...
 * @version 1.0
 */
public class TipoEntradaActivarAlertaTierrasWSDTO extends GenericoDTO {
