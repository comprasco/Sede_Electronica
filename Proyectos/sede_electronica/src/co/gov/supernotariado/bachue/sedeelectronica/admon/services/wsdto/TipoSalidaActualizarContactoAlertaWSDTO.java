 ...
 * --------------------------------------
 * Nombre del archivo: TipoSalidaActualizarContactoAlertaWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoSalidaActualizarContactoAlertaWSDTO
 ...
 * @version 1.0
 */
public class TipoSalidaActualizarContactoAlertaWSDTO extends GenericoDTO implements ISalidaServicioWSDTO
{
