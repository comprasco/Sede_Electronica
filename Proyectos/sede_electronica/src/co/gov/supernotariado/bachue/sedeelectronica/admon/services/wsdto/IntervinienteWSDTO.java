 ...
 * --------------------------------------
 * Nombre del archivo: IntervinienteWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: IntervinienteWSDTO
 ...
 * <br>
 * Contiene propiedades para representar los datos del objeto Interviniente.
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class IntervinienteWSDTO implements Serializable {
