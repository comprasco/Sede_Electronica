 ...
 * --------------------------------------
 * Nombre del archivo: EnumParametrosDesasociarPnAEeAdmon.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.common.mailer.enums.parametrosPlantillas
 * Nombre del elemento: EnumParametrosDesasociarPnAEeAdmon
 ...
 * A entidad especial admon.
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public enum EnumParametrosDesasociarPnAEeAdmon {
	 ...
	 * EnumParametrosDesasociarPnAEeAdmon.
	 *
	 * @param as_codigoPlanilla el parametro codigo planilla
	 */
	private EnumParametrosDesasociarPnAEeAdmon(String as_codigoPlanilla) {
