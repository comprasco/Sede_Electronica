 ...
 * --------------------------------------
 * Nombre del archivo: TipoSalidaObtenerProductoWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoSalidaObtenerProductoWSDTO
 ...
 * @version 1.0
 */
public class TipoSalidaObtenerProductoWSDTO extends GenericoDTO implements ISalidaServicioWSDTO
{
