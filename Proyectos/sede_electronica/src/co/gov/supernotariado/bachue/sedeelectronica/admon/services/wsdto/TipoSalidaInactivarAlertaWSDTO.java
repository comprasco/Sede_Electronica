 ...
 * --------------------------------------
 * Nombre del archivo: TipoSalidaInactivarAlertaWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoSalidaInactivarAlertaWSDTO
 ...
 * @version 1.0
 */
public class TipoSalidaInactivarAlertaWSDTO extends GenericoDTO implements ISalidaServicioWSDTO
{
