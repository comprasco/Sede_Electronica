 ...
 * --------------------------------------
 * Nombre del archivo: TipoSalidaAgregarMatriculaAlertaWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoSalidaAgregarMatriculaAlertaWSDTO
 ...
 * @version 1.0
 */
public class TipoSalidaAgregarMatriculaAlertaWSDTO extends GenericoDTO implements ISalidaServicioWSDTO {
