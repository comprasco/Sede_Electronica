 ...
 * --------------------------------------
 * Nombre del archivo: EnumParametrosAprobacionPersonaJuridica.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.common.mailer.enums.parametrosPlantillas
 * Nombre del elemento: EnumParametrosAprobacionPersonaJuridica
 ...
 * @version 1.0
 */
public enum EnumParametrosAprobacionPersonaJuridica {
	 ...
	 * EnumParametrosAprobacionPersonaJuridica.
	 *
	 * @param as_codigoPlanilla el parametro codigo planilla
	 */
	private EnumParametrosAprobacionPersonaJuridica(String as_codigoPlanilla) {
