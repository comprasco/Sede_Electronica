 ...
 * --------------------------------------
 * Nombre del archivo: TipoEntradaObtenerTurnosRefPagoWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoEntradaObtenerTurnosRefPagoWSDTO
 ...
 * @version 1.0
 */
public class TipoEntradaObtenerTurnosRefPagoWSDTO extends GenericoDTO {
