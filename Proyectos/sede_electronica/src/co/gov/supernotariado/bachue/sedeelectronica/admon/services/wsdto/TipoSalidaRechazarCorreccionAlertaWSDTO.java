 ...
 * --------------------------------------
 * Nombre del archivo: TipoSalidaRechazarCorreccionAlertaWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoSalidaRechazarCorreccionAlertaWSDTO
 ...
 * @version 1.0
 */
public class TipoSalidaRechazarCorreccionAlertaWSDTO extends GenericoDTO implements ISalidaServicioWSDTO
{
