 ...
 * --------------------------------------
 * Nombre del archivo: AlertaWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: AlertaWSDTO
 ...
 * <br>
 * Contiene propiedades para representar los datos del objeto Alerta.
 *
 * @author Smartsoft Solutions S.A.S
 * @version 1.0
 */
public class AlertaWSDTO extends GenericoDTO
{
