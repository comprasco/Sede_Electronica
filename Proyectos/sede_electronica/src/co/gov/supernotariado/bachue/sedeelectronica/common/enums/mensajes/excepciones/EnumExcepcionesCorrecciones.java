 ...
 * --------------------------------------
 * Nombre del archivo: EnumExcepcionesCorrecciones.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.common.enums.mensajes.excepciones
 * Nombre del elemento: EnumExcepcionesCorrecciones
 ...
 * @version 1.0
 */
public enum EnumExcepcionesCorrecciones implements IEnumCatalogoMensajes, Serializable {
	 ...
	 */
	public static final String NOMBRE_BUNDLE = "excepciones.excepcion_correcciones_%s";
	 ...
	 */
	private EnumExcepcionesCorrecciones(String as_codigoError) {
