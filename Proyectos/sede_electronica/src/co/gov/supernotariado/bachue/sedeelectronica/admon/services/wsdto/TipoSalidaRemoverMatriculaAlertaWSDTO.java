 ...
 * --------------------------------------
 * Nombre del archivo: TipoSalidaRemoverMatriculaAlertaWSDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.sedeelectronica.admon.services.wsdto
 * Nombre del elemento: TipoSalidaRemoverMatriculaAlertaWSDTO
 ...
 * @version 1.0
 */
public class TipoSalidaRemoverMatriculaAlertaWSDTO extends GenericoDTO implements ISalidaServicioWSDTO 
{
